...
const getStrengthLabel = (score: number): { strength: string; color: string } => {
  ...
  if (score <= 2) return { strength: 'Muy débil', color: '#f44336' }; 
  if (score === 3) return { strength: 'Débil', color: '#ff9800' };     
  if (score === 4) return { strength: 'Moderada', color: '#ffeb3b' };  
  return { strength: 'Fuerte', color: '#4caf50' };                     
};
