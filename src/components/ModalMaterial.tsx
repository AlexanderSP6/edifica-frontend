...
import { materialValidationSchema, getInitialValues } from '../schemas/materialValidationSchema';
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        const errorMessage = err.response?.data?.message || 'Error al guardar el material';
      ...
      <DialogTitle sx={{ pb: 1 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Typography variant="h6" component="span" sx={{ fontWeight: 600 }}>
            {itemEdit ? 'Editar Material' : 'Nuevo Material'}
          </Typography>
          <IconButton
            onClick={handleClose}
            disabled={loading}
          ...
          <Grid container spacing={3}>
            ...
            <Grid size={{ xs: 12 }}>
              <TextField
                fullWidth
                label="Descripción"
                placeholder="Ej: Cemento Portland, Arena fina, Ladrillo gambote..."
            ...
            <Grid size={{ xs: 12, sm: 6 }}>
              ...
              <TextField
                ...
                helperText="Cálculo automático (rendimiento × precio)"
              />
            </Grid>
